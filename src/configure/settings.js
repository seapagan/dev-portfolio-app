...
export const settings = {
  ...
  about: [
    ...
    "I am fully setup for Remote work with a dedicated office space and " +
      "Full-Fibre Gigabit Broadband, 20 minutes drive from Berwick-Upon-" +
  ...
  social: [
    ...
    {
      name: "LinkedIn",
      link: "https://www.linkedin.com/in/gnramsay",
      icon: socialLinkedIn,
    },
    {
      name: "Medium",
  ...
  skills: [
    {
      ...
      desc:
        ...
        "backend technologies, including FastaAPI and Django.",
    },
    {
      name: "React JS",
      icon: reactLogo,
